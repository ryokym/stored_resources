...
export default function() {
    const remove = {
        ...
        undecorate : function() {
            document.getElementById("remove_area").classList.remove("removeMouseOver")
        },
        ...
        droped : function(e, data) {
            ...
            if (confirm(main.dirname + '/' + main.name + 'を削除しますか?') === false) {
                ...
                const done = function() {main.adjust()},
    ...
    return function() {
        ...
        common.rotate(common.mode, ['change', 'remove'], function(another){common.setmode(another)});
        ...
        $('#remove_drop_area').droppable({
            ...
            drop: function(e, data) {remove.droped(e, data)},
        });
    }();
}
