...
$defaultRows[] = preg_grep($exclusionPattern, scandir(getParentDirName()));
...
<div class="container">
    <div class="column">
        <div class="level" data-level="1" data-dir="<?= $currentDirName; ?>"><?php
            foreach ($defaultRows as $index => $row): ?>
                <div class="row <?php if ($index === 1) echo 'createNewDirRow'; ?>"><?php
                    ...
                    elseif ($index === 1): ?>
                        ...
                        <p class="row_item" data-dir="<?= $currentDirName ?>"><?= $row ?></p><?php
                    endif; ?>
                </div><?php
            endforeach; ?>
        </div>
